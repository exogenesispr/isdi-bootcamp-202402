...
export default function ProviderScreen({ route }) {
    ...
    return (
        <View style={styles.container}>
            ...
            {isCommunity ? <TouchableOpacity style={styles.button} onPress={handleDiscordCommunityLinkPress}>
                <Text style={styles.buttonText}>Join Discord</Text>
            </TouchableOpacity>
                :
                <TouchableOpacity style={styles.button} onPress={handleDiscordUserLinkPress} >
