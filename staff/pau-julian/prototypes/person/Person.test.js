...
assert.equalsValue(person.getFullYear(), 2000)
assert.equalsValue(person.getMonth(), 0)
assert.equalsValue(person.getDate(), 31)
assert.equalsValue(person.getHours(), 16)
assert.equalsValue(person.getMinutes(), 45)
